...
(window.EXTRAS = window.EXTRAS || {}).nat = [
  ...
  { id: 'xt3', lvl: 1, type: 'qcm', q: 'Tu consultes un site web depuis chez toi, derrière ta box. Quelle adresse IP le site voit-il ?',
    choices: ['L’adresse publique de ta box', 'L’adresse privée de ton PC (192.168.x.x)', 'L’adresse MAC de ton PC', 'L’adresse de ton serveur DNS'], good: 0,
    hints: ['Les adresses privées ne circulent pas sur Internet.'],
    explain: 'La box remplace ton adresse privée par son adresse <b>publique</b> (PAT) : le site ne voit que la box. Sur un routeur Cisco, cette traduction se lit avec <code>show ip nat translations</code>.' },
  /* ---------- Difficile ---------- */
